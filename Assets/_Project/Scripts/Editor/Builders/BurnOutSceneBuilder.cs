...
namespace BurnOut.Editor
{
    public static class BurnOutSceneBuilder
    {
        ...
        private static void BuildLevel()
        {
            ...
            var key = InstantiatePrefab("PF_Key", "Items", interactables.transform); key.transform.position = new Vector3(27f, 2.8f, 0f);
            var door = InstantiatePrefab("PF_LockedDoor", "Environment", interactables.transform); door.transform.position = new Vector3(31.5f, .4f, 0f);
